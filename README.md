...
O problema de depender apenas desse arquivo para rodar o servidor é ruim, porque qualquer mudança que a gente faz nessa parte aqui:
...
**_dev_** porque o nome do script que a gente deu foi dev, e a execução dele é rodar o **nodemon** e o caminho do arquivo 👍
